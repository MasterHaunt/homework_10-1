...
def sort_by_date(transactions: list, order: bool = True) -> list:
    ...
    - если второй параметр не передан или передан в значении "True" -> по убыванию (от последних к ранним);
    - если второй параметр передан в значении "False" -> по возрастанию (от ранних к поздним)"""
